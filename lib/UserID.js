...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserID = function () {
	    ...
	    function UserID() {
	         ...
	         * @type {EverCookie}
	         */
	        this.EverCookie = new _EverCookie2.default("UserID_1.0.7");
	    ...
	    UserID.clearPrevious = function clearPrevious() {
	        ...
	        if (typeof localStorage !== "undefined") {
	            ...
	            for (var key in localStorage) {
	                 ...
	                 */
	                if (key.indexOf("FingerPrint") !== -1 && key.indexOf("UserID_1.0.7") === -1) {
	                    /**
